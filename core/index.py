...
class CompressedInvertedIndex(InvertedIndex):
    ...
    def _process_batch(self):
        ...
        for numeric_id, tokens in tqdm(self._pending_docs):
...
class SearchEngine:
    ...
    def add_document(self, doc: Document):
        ...
        self.direct_index.add_document(doc)
